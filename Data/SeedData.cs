...
public static class DataSeeder
{
    ...
    private static void SeedUsers(ModelBuilder modelBuilder)
    {
        const string adminPasswordHash =
            "$2a$11$Dwjmx1HTPGBHygbMwcBGpuq4AVknT0PzpfLDVzhcEIJRImpx8dJbG";
        ...
        modelBuilder
            ...
            .HasData(
                ...
                Leaf(
                    ...
                    "Jeans",
                    "jeans",
                    parentId: CategoryIds.Bottoms,
                    sortOrder: 1
                )
            );
    }

    private static Category Branch(
        int id,
        string name,
        string slug,
        int? parentId,
    ...
    private static void SeedProductsWithRelations(ModelBuilder modelBuilder)
    {
        var baseProducts = new[]
        {
            new
            {
                ...
                Price = 199.99m,
                ImageUrl = "/images/products/svart-tshirt.jpg",
                CategoryId = CategoryIds.TShirts,
            },
            new
            {
                Name = "Blue Jeans",
                Description = "Classic slim-fit blue jeans",
                Price = 699.99m,
                ImageUrl = "/images/products/bla-jeans.jpg",
            ...
            new
            {
                ...
                Price = 899.99m,
                ImageUrl = "/images/products/vita-sneakers.jpg",
                CategoryId = CategoryIds.Sneakers,
            },
            new
            {
                ...
                Price = 1299.99m,
                ImageUrl = "/images/products/lader-handvaska.jpg",
                CategoryId = CategoryIds.Bags,
            },
            new
            {
                Name = "Cotton Hoodie",
                Description = "Cozy hoodie in soft cotton",
                Price = 499.99m,
                ImageUrl = "/images/products/bomulls-hoodie.jpg",
        ...
        for (int multiplier = 0; multiplier < PRODUCT_MULTIPLIER; multiplier++)
        {
            foreach (var baseProduct in baseProducts)
            {
                ...
                relations.Add(
                    new { CategoriesId = baseProduct.CategoryId, ProductsId = productId }
                );
